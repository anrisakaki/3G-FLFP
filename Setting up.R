...
m4c1_04 <- read_dta(file = "VHLSS/2004/m4c1.dta")
...
m4c_06 <- read_dta(file = "VHLSS/2006/muc4c.dta")
...
m4c1_08 <- read_dta(file = "VHLSS/2008/Hhold/muc4c1.dta")
...
m4c1_10 <- read_dta(file = "VHLSS/2010/muc4c1.dta")
...
m1c_12 <- read_dta(file = "VHLSS/2012/Muc1C.dta")
m2a_12 <- read_dta(file = "VHLSS/2012/Muc2A1.dta")
m4c1_12 <- read_dta(file = "VHLSS/2012/Muc4C1.dta")
...
m1c_14 <- read_dta(file = "VHLSS/2014/Muc1C.dta")
m2a_14 <- read_dta(file = "VHLSS/2014/Muc2A.dta")
m4a_14 <- read_dta(file = "VHLSS/2014/Muc4A.dta")
m4c1_14 <- read_dta(file = "VHLSS/2014/Muc4C1.dta")
...
m4c1_16 <- read_dta(file = "VHLSS/2016/Household/Muc4C1.dta")
...
m4c1_18 <- read_dta(file = "VHLSS/2018/2 - Data/1 - Households/MUC4C1.dta")
